        ...
        <section id="home"
            ...
            >
                <div className="space-y-4 max-w-4xl mt-24 md:mt-16">
                    <div
                        className="text-[8px] sm:text-xs md:text-lg inline-block px-4 py-1.5 mb-4 font-medium bg-green-500/10 text-green-400 rounded-full border border-green-500/20">
            ...
            >
                <div
                    className="mt-8 md:mt-24 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 border-t border-white/5 pt-12">
                    <div className="flex flex-col">
                        <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">5+</span>
                        <span
                            className="text-xs md:text-sm text-muted-foreground uppercase tracking-wider">Years Experience</span>
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span
                            className="text-xs md:text-sm text-muted-foreground uppercase tracking-wider">Expert</span>
                    </div>
                    <div className="flex flex-col">
                        <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">Full Stack</span>
                        <span
                            className="text-xs md:text-sm text-muted-foreground uppercase tracking-wider">Developer</span>
                    </div>
                </div>
            </AnimatedContent>
            <div className="absolute bottom-10 animate-bounce opacity-50 items-center justify-center">
